...
namespace Eniture\UnishippersSmallPackageQuotes\Observer;
...
class OrderPlacebeforeSaveData implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        try {
            ...
            if (strpos($method, 'ENUnishippersSmpkg') !== false) {
                $orderDetailData = $this->coreSession->getUnishippersSmpkgOrderDetailSession();
    ...
    private function setQuotesIfSingleShipment($orderDetailData, $order)
    {
        ...
        $titlePart = "Unishippers Small Package Quotes - ";
        $newData = [];
