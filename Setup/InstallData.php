...
namespace Eniture\UnishippersSmallPackageQuotes\Setup;

use Eniture\UnishippersSmallPackageQuotes\App\State;
...
class InstallData implements InstallDataInterface
{
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $this->attrNames();
        $this->addUnishippersSmallAttributes();
        $this->createUnishippersSmallWarehouseTable();
     ...
     */
    private function addUnishippersSmallAttributes()
    {
        $count = 71;
        ...
        if ($isDropshipLocationExist == null) {
            $this->addProductAttribute(
                ...
                'Drop Ship Location',
                'select',
                'Eniture\UnishippersSmallPackageQuotes\Model\Source\DropshipOptions',
                75
            );
        } else {
    ...
    private function createUnishippersSmallWarehouseTable()
    {
    ...
    private function createEnitureModulesTable()
    {
        ...
        $newModuleName  = 'ENUnishippersSmpkg';
        $scriptName     = 'Eniture_UnishippersSmallPackageQuotes';
        ...
        if ($isNewModuleExist == 0) {
            $insertDataArr = [
                ...
                'dropship_source' => 'Eniture\UnishippersSmallPackageQuotes\Model\Source\DropshipOptions'
            ];
    ...
    private function checkLILExistenceColumnForEnModules()
    {
        ...
        $this->connection->update($tableName, ['is_ltl' => 0], "module_name = 'ENUnishippersSmpkg'");
    }
