 ...
 */
class UnishippersSmpkgManageAllQuotes
{
    /**
    ...
    public function getQuotesResultArr($request)
    {
        ...
        if ($quotesCount == 1) {
            $servicesArr = $this->UnishippersGetAllQuotes();
            return $servicesArr;
     ...
     * @return array
     */
    public function UnishippersGetAllQuotes($getMinimum = false, $isMultishipment = false)
    {
        ...
        foreach ($this->quotes as $key => $quote) {
            ...
            $unishippersSmpkgResultData = $dataHelper->getQuotesResults($quote, $getMinimum, $isMultishipment, $this->scopeConfig);

            if ($unishippersSmpkgResultData != false && $unishippersSmpkgResultData !== null) {
                $resultArr[$key] = $unishippersSmpkgResultData;
            }
        }
