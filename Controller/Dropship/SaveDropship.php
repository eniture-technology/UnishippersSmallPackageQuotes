<?php
namespace Eniture\UnishippersSmallPackageQuotes\Controller\Dropship;

use Eniture\UnishippersSmallPackageQuotes\Helper\Data;
use Eniture\UnishippersSmallPackageQuotes\Model\WarehouseFactory;
...
class SaveDropship extends Action
{
    ...
    public function execute()
    {
        ...
        $inputDataArr = $this->dataHelper->unishippersSmOriginArray($saveDsData);
        $validateData = $this->dataHelper->unishippersSmValidatedPostData($inputDataArr);
