...
namespace Eniture\UnishippersSmallPackageQuotes\Controller\Adminhtml\Product;
...
class Edit extends \Magento\Catalog\Controller\Adminhtml\Product\Edit
{
     ...
     * @param \Eniture\UnishippersSmallPackageQuotes\Model\EnituremodulesFactory $enModuleFactory
    ...
    public function __construct(
        ...
        \Eniture\UnishippersSmallPackageQuotes\Model\EnituremodulesFactory $enModuleFactory,
    ...
    public function execute()
    {
        ...
        $collection = $this->enModuleFactoryCreate->getCollection()
            ->addFilter('module_name', ['eq' => 'ENUnishippersSmpkg']);
    ...
    public function varifyModuleEntry($haveEntry)
    {
        if (empty($haveEntry)) {
            $data = [
                'module_name'           => 'ENUnishippersSmpkg',
                'module_script'         => 'Eniture_UnishippersSmallPackageQuotes',
