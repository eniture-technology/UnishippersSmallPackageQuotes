...
class UnishippersSmallOriginAddress extends Action
{
    /**
     * @var Data Object
     */
    ...
    public function execute()
    {
        ...
        if ($originZip) {
            $mapResult = $this->googleApiCurl($originZip, UnishippersSmConstants::GOOGLE_URL);
    ...
    {
        $licenseKey = $this->scopeConfig->getValue('UnishippersSmConnSetting/first/licenseKey', ScopeInterface::SCOPE_STORE);
        $post = [
            'acessLevel'        => 'address',
            'address'           => $originZip,
        ...
        $response = $this->dataHelper->unishippersSmSendCurlRequest($curlUrl, $post, true);
